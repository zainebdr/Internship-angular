...
@Component({
  selector: 'app-list-etudiant-depart',
  templateUrl: './list-etudiant-depart.component.html',
  styleUrls: ['./list-etudiant-depart.component.scss']
})
export class ListEtudiantDepartComponent implements OnInit {
